...
query = {
    ...
    'add_ons_live': [{'name': 'VIP Tickets', 'price': 2000, 'quantity': 0}, {'name': 'Laptop Rental', 'price': 1500, 'quantity': 0}],
    'add_ons_total': [{'name': 'VIP Tickets', 'price': 2000, 'quantity': 0}, {'name': 'Laptop Rental', 'price': 1500, 'quantity': 0}],
